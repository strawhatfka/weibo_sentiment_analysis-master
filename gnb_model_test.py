...
print('模型加载中...')
model = joblib.load('./gnb_weibo_output/'+'weibo_lr_'+FLAG+'_model.pkl')
print('模型加载结束...')
...
def predict():
    ...
    if review == 'exit':
        ...
        try:
            ...
            print(sentences)
            review_ids = vectorizer.transform(sentences).todense()
...
def evaluate(file_path):
    ...
    x_datas = vectorizer.transform(x_datas).todense()
